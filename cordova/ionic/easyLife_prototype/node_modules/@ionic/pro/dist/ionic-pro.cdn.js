...
var Deploy = /** @class */ (function () {
    ...
    Deploy.prototype.init = function () {
        ...
        this.app.getPlugin().then(async (plugin: any) => {
          const deployInfo = await this.info();
          console.log('Loaded deploy info', deployInfo);
          plugin.deploy.init({
...
var Monitoring = /** @class */ (function () {
    ...
    Monitoring.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var deviceInfo, deployInfo, e_1, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.app.deploy.info()];
                    case 4:
                        deployInfo = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
                        e_2 = _a.sent();
                        console.error('Error loading deploy information.', e_2);
                        return [3 /*break*/, 6];
                    case 6:
                        if (this.app.options.monitoringIdentify) {
                            this.identify(this.app.getUid(), deviceInfo, deployInfo);
                        }
                        return [2 /*return*/];
                }
            });
    ...
    Monitoring.prototype.drainQueue = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var deployInfo, e_3, manifest, payload;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 3:
                        e_3 = _a.sent();
                        deployInfo = {};
                        console.error('Error loading deploy information.', e_3);
                        return [3 /*break*/, 4];
                    case 4:
                        ...
                        payload = {
                            ...
                            pro: {
                                ...
                                snapshot_id: manifest.snapshot_id || deployInfo.deploy_uuid,
                                channel: manifest.channel || deployInfo.channel,
                                ts: +new Date
                            },
                            errors: this.queue.slice()
                        };
    ...
    Monitoring.prototype.identify = function (uid, info, deployInfo) {
        return this.app.api.post("/monitoring/" + this.app.appId + "/u", {
            enduser_id: uid,
            is_native: info.is_native,
            os_version: info.osVersion || '',
            device: info.model || '',
            platform: info.platform || info.browserMobileOS,
            platform_version: info.platform_version,
            user_agent: info.browserUserAgent,
            utc_offset: info.utcOffset,
            manufacturer: info.manufacturer,
            model: info.model,
            bundle_id: info.bundleName,
            bundle_version: info.bundleVersion,
            version: info.version
        }).catch(function (err) {
            console.error('Unable to ID user', err);
        });
    };
    return Monitoring;
}());
...
var getAppId = function (script) {
    return script.getAttribute('data-app-id');
};
var getProvidedCodeVersion = function (script) {
    return script.getAttribute('data-app-version');
};
var getScript = function () {
    var scripts = document.querySelectorAll('script');
    for (var i = 0; i < scripts.length; i++) {
        var script = scripts[i];
        if (script.src.indexOf('ionic-pro') >= 0) {
            return script;
        }
    }
    return null;
 ...
 */
var bootstrapCDN = function () {
    var script = getScript();
    if (!script) {
        console.error('Unable to load Pro Client from CDN. Couldn\'t find our script include.');
        return;
    }
    var appId = getAppId(script);
    var appVersion = getProvidedCodeVersion(script);
    return Pro.init(appId, {
...
var Pro = /** @class */ (function () {
    function Pro(appId, customOptions) {
        ...
        this.servicesReadyPromise = this.run();
    }
    /**
    ...
    Pro.prototype.getPlugin = function () {
        return this.platformReady().then(function (platformInfo) {
            if (platformInfo.system === 'cordova') {
                ...
                return Promise.reject('No Plugin Available');
            }
        });
    };
    /**
    ...
    Pro.prototype.platformReady = function () {
        var _this = this;
        return new Promise(function (resolve, reject) {
            if (_this.platformReadyInfo && _this.platformReadyInfo.ready === true) {
                return resolve(_this.platformReadyInfo);
            }
            return _this.platformReadyPromise;
        });
    };
    /**
     * @return the unique identifier for the user (anonymous, not the pro user id)
     */
    Pro.prototype.getUid = function () {
        return this.uid;
    };
    /**
